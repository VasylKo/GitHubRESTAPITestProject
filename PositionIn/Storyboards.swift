...
struct Storyboards {
    ...
    struct Main {
        ...
        static func instantiateMainMenuStoryboardId() -> MainMenuViewController! {
            return self.storyboard.instantiateViewControllerWithIdentifier("MainMenuStoryboardId") as! MainMenuViewController
        }

        static func instantiateMapStoryboardId() -> MapViewController! {
            return self.storyboard.instantiateViewControllerWithIdentifier("MapStoryboardId") as! MapViewController
        }
    }
}
